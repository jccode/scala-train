...
/**
  ...
  * the encoder for :: has to assemble an object
...
object Main extends App {
  ...
  val employee = Employee("Tom", 18, true)
  println("Employee " + employee)
  println("Employee as JSON: " + Json.stringify(encodeJson(employee)))
}